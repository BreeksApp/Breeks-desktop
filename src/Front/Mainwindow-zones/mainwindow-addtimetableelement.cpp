...
void MainWindow::setStyleAddTimetableElementForm() {
  ui->addTimetableElementGb->setStyleSheet(
    "QGroupBox{background: #cce4ff; border: 1px solid #C6C6C6; border-radius: 18px;}"
  );

  indexCurrentTag_ = 0;
  ui->timetableElementTagColor->setStyleSheet(
    "QPushButton{background: " + tag::ARR_COLORS[indexCurrentTag_] + "; border-radius: 6px;}"
  );
  ...
  ui->timetableElementDescription->setStyleSheet(
  ...
  ui->addTimetableElementButton->setStyleSheet(
    "QPushButton{background: #b9de6f; border-radius: 20px; border: 0.2px solid #d7eba9; color: #ffffff; font-size: 12pt; font-weight: bold;} "
  ...
  ui->timetableElementTimeStart->setStyleSheet(
    "QTimeEdit{background: #F7F7F7; border-radius: 8px;}"
    "QTimeEdit::up-button {"
  ...
  ui->timetableElementTimeEnd->setStyleSheet(
    "QTimeEdit{background: #F7F7F7; border-radius: 8px;}"
    "QTimeEdit::up-button {"
    "border-image:url(:/Images/Front/Images/caret-up.png);"
    "width: 15px;}"
...
void MainWindow::on_mnTimetableElemnetButton_clicked() {
  if (arrAddTimetableElementFormDaysCheck_[0] == false) {
    ui->mnTimetableElemnetButton->setStyleSheet(
      "QPushButton{background: #b9de6f; border-radius: 4px;"
      "font-size: 10pt;}"
      "QPushButton:hover{background: #e5f2c6; border-radius: 4px;"
      "font-size: 10pt;}"
    );
...
void MainWindow::on_tuTimetableElemnetButton_clicked() {
  if (arrAddTimetableElementFormDaysCheck_[1] == false) {
    ui->tuTimetableElemnetButton->setStyleSheet(
      "QPushButton{background: #b9de6f; border-radius: 4px;"
      "font-size: 10pt;}"
      "QPushButton:hover{background: #e5f2c6; border-radius: 4px;"
      "font-size: 10pt;}"
...
void MainWindow::on_weTimetableElemnetButton_clicked() {
  if (arrAddTimetableElementFormDaysCheck_[2] == false) {
    ui->weTimetableElemnetButton->setStyleSheet(
      "QPushButton{background: #b9de6f; border-radius: 4px;"
      "font-size: 10pt;}"
      "QPushButton:hover{background: #e5f2c6; border-radius: 4px;"
      "font-size: 10pt;}"
...
void MainWindow::on_thTimetableElemnetButton_clicked() {
  if (arrAddTimetableElementFormDaysCheck_[3] == false) {
    ui->thTimetableElemnetButton->setStyleSheet(
      "QPushButton{background: #b9de6f; border-radius: 4px;"
      "font-size: 10pt;}"
      "QPushButton:hover{background: #e5f2c6; border-radius: 4px;"
      "font-size: 10pt;}"
...
void MainWindow::on_frTimetableElemnetButton_clicked() {
  if (arrAddTimetableElementFormDaysCheck_[4] == false) {
    ui->frTimetableElemnetButton->setStyleSheet(
      "QPushButton{background: #b9de6f; border-radius: 4px;"
      "font-size: 10pt;}"
      "QPushButton:hover{background: #e5f2c6; border-radius: 4px;"
      "font-size: 10pt;}"
...
void MainWindow::on_stTimetableElemnetButton_clicked() {
  if (arrAddTimetableElementFormDaysCheck_[5] == false) {
    ui->stTimetableElemnetButton->setStyleSheet(
      "QPushButton{background: #b9de6f; border-radius: 4px;"
      "font-size: 10pt;}"
      "QPushButton:hover{background: #e5f2c6; border-radius: 4px;"
      "font-size: 10pt;}"
...
void MainWindow::on_addTimetableElementButton_clicked() {
  ...
  if ((ui->timetableElementTimeStart->time() < ui->timetableElementTimeEnd->time()) ||
      (ui->timetableElementTimeEnd->time().toString() == "00:00:00")) {
